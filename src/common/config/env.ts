...
export const envSchema = z.object({
  SEARCH_HASH_PEPPER: z.string().min(32, 'Pepper must be at least 32 characters'),
  VERIFICATION_HASH_SECRET: z.string().min(32, 'Pepper must be at least 32 characters'),
